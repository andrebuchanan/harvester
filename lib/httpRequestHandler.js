...
http.get("/otp/:fleet/:date?/:timezone?", doRequest);
// Weather Images by port and type
http.get("/weather/image/:portCode/:weather", doRequest);
...
http.param("timezone", function(req, res, next, timezone)
{
  // If date is valid, process request.
  if(timezone)
  {

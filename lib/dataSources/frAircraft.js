...
=======
      parsedInput = input;
>>>>>>> gather aircraft types from flight radar
...
=======
    ...
    {
      i++;
      if (i % 1000 === 0) log(parsedInput[item]);
      // log(typeof parsedInput[item]);
      // var xitem = parsedInput[item] + "";
      var ary = parsedInput[item];
      // Aircraft items are arrays. Only process those.
      // if (typeof ary === "object" && ary.isArray() && ary[9].length > 1)
      // {
      //   aircraft = {};
      //   aircraft[CTI.aircraftTail]  = ary[9];
      //   aircraft[CTI.equipment]     = ary[8];
      //   aircrafts.push(aircraft);
      // }
>>>>>>> gather aircraft types from flight radar
